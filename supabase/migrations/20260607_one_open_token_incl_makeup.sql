-- ============================================================
-- Max. EIN offener Gutschein – Lücke beim Nachhol-Storno schließen
-- ============================================================
-- Bisher übersprang das Stornieren eines Nachholtermins die „offener Gutschein"-
-- Prüfung komplett. Dadurch konnte ein Kunde trotz offenem Gutschein einen
-- zweiten erzeugen (zwei Gutscheine gleichzeitig). Jetzt gilt die Sperre für
-- JEDE Kunden-Stornierung (Original UND Nachholtermin): solange ein unbenutzter,
-- gültiger Gutschein existiert, ist kein weiteres Storno möglich. Ein bereits
-- gebuchter (zukünftiger) Nachholtermin blockt weiterhin NICHT. makeup_count-Cap,
-- 3-Stunden-Frist, Tageslimit, Kapazität und Admin-Ausnahme unverändert.
-- ============================================================
...
BEGIN
  ...
  -- Max. EIN offener Gutschein gleichzeitig: jede Kunden-Stornierung (auch die
  -- eines Nachholtermins) ist gesperrt, solange ein unbenutzter Gutschein
  -- existiert. Ein bereits gebuchter (zukünftiger) Nachholtermin blockt NICHT.
