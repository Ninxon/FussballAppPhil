...
export const styles = StyleSheet.create({
  ...
  billingAdjustNote: { fontSize: 13, fontWeight: '700', color: '#4A8FE8', marginTop: 4 },
  billingAdjustRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 14 },
  billingAdjustLabel: { flex: 1, fontSize: 13, fontWeight: '600', color: '#4A6080' },
  billingAdjustBtn: {
    width: 38, height: 38, borderRadius: 10,
    alignItems: 'center', justifyContent: 'center',
    backgroundColor: 'rgba(74,143,232,0.1)',
  },
  billingAdjustBtnMuted: { backgroundColor: 'rgba(21,34,56,0.05)' },
  billingAdjustBtnText: { fontSize: 20, fontWeight: '700', color: '#4A8FE8', lineHeight: 24 },
  billingAdjustBtnTextMuted: { color: '#9BAFC7' },
